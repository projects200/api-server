...
- 선택 가능한 선호 운동 종류 목록 조회 API #GET# `/api/v1/exercise-types`

- 현재 사용자가 보유하고 있는 선호 운동 목록 조회 API #GET# `/api/v1/preferred-exercises`

- 현재 사용자의 선호 운동 종류 목록 생성 API #POST# `/api/v1/preferred-exercises`

- 현재 사용자의 선호 운동 종류 목록 삭제 API #DELETE# `/api/v1/preferred-exercises`

- 현재 사용자의 선호 운동 종류 목록 수정 API #PATCH# `/api/v1/preferred-exercises`
...
- 메시지 생성(전송) API #POST# `/api/v1/chat-rooms/{chatroomId}/messages`

- 새 메시지 목록 조회 API #GET# `/api/v1/chat-rooms/{chatroomId}/messages/new`

- 채팅방 나가기 API #DELETE# `/api/v1/chat-rooms/{chatroomId}`

- 웹소켓 전환 티켓 발급 API #POST# `/api/v1/chat-rooms/{chatroomId}/ticket`

=== xref:차단-API.html[차단 API]

- 회원 차단 API #POST# `/api/v1/members/{memberId}/block`

- 회원 차단 해제 API #DELETE# `/api/v1/members/{memberId}/block`

- 차단한 회원 목록 조회 API #GET# `/api/v1/members/blocks`

=== xref:알림-API.html[알림 API]

- 특정 FCM 토큰의 푸시 알림 설정 목록 조회 API #GET# `/api/v1/notification-settings/device`

- 특정 FCM 토큰 기반의 알림 설정 변경 API #PATCH# `/api/v1/notification-settings/device`
...
- 특정 피드의 좋아요 작성 API #POST# `/api/v1/feeds/{feedId}/like`