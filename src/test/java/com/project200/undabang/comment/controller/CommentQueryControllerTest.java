...
class CommentQueryControllerTest extends AbstractRestDocSupport {
        ...
        private List<CommentResponse> createSampleComments() {
                ...
                CommentResponse reply = new CommentResponse(
                                ...
                                new TaggedMemberRecord(taggedId, "태그유저"),
                                new ArrayList<>());
                                        ...
                                        .andDo(document.document(
                                                        ...
                                                        responseFields(commonResponseFieldsForList(
                                                                        ...
                                                                        fieldWithPath("data[].memberId")
                                                                                        ...
                                                                                        .description("댓글 작성자의 회원 고유 식별자(ID) 입니다."),
                                                                        fieldWithPath("data[].memberNickname")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("댓글 작성자의 닉네임입니다."),
                                                                        fieldWithPath("data[].memberProfileImageUrl")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("댓글 작성자의 프로필 이미지 URL입니다.")
                                                                                        .optional(),
                                                                        fieldWithPath("data[].memberThumbnailUrl")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("댓글 작성자 프로필 썸네일 URL입니다.")
                                                                                        .optional(),
                                                                        ...
                                                                        fieldWithPath("data[].likesCount")
                                                                                        .type(JsonFieldType.NUMBER)
                                                                                        .description("댓글 좋아요 수 입니다."),
                                                                        fieldWithPath("data[].commentIsLiked")
                                                                                        .type(JsonFieldType.BOOLEAN)
                                                                                        .description("현재 사용자의 댓글 좋아요 여부입니다."),
                                                                        fieldWithPath("data[].createdAt")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("댓글이 작성된 시간입니다."),
                                                                        fieldWithPath("data[].taggedMember")
                                                                                        .type(JsonFieldType.OBJECT)
                                                                                        .description("태그된 멤버 정보입니다.")
                                                                                        .optional(),
                                                                        fieldWithPath("data[].taggedMember.memberId")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("태그된 멤버의 고유 식별자(ID) 입니다.")
                                                                                        .optional(),
                                                                        fieldWithPath("data[].taggedMember.memberNickname")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("태그된 멤버의 닉네임 입니다.")
                                                                                        .optional(),
                                                                        fieldWithPath("data[].children")
                                                                                        .type(JsonFieldType.ARRAY)
                                                                                        .description("대댓글 목록입니다."),
                                                                        fieldWithPath("data[].children[].commentId")
                                                                                        .type(JsonFieldType.NUMBER)
                                                                                        .description("대댓글 고유 식별자(ID) 입니다."),
                                                                        fieldWithPath("data[].children[].memberId")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("대댓글 작성자 회원 고유 식별자(ID) 입니다."),
                                                                        fieldWithPath("data[].children[].memberNickname")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("대댓글 작성자 닉네임 입니다."),
                                                                        fieldWithPath("data[].children[].memberProfileImageUrl")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("대댓글 작성자 프로필 이미지 URL")
                                                                                        .optional(),
                                                                        fieldWithPath("data[].children[].memberThumbnailUrl")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("대댓글 작성자 프로필 썸네일 URL")
                                                                                        .optional(),
                                                                        fieldWithPath("data[].children[].content")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("대댓글 내용"),
                                                                        fieldWithPath("data[].children[].likesCount")
                                                                                        .type(JsonFieldType.NUMBER)
                                                                                        .description("대댓글 좋아요 수"),
                                                                        fieldWithPath("data[].children[].commentIsLiked")
                                                                                        .type(JsonFieldType.BOOLEAN)
                                                                                        .description("현재 사용자의 대댓글 좋아요 여부"),
                                                                        fieldWithPath("data[].children[].createdAt")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("대댓글 작성 시간"),
                                                                        fieldWithPath("data[].children[].taggedMember")
                                                                                        .type(JsonFieldType.OBJECT)
                                                                                        .description("대댓글에 태그된 멤버 정보")
                                                                                        .optional(),
                                                                        fieldWithPath("data[].children[].taggedMember.memberId")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("대댓글에 태그된 멤버 ID")
                                                                                        .optional(),
                                                                        fieldWithPath("data[].children[].taggedMember.memberNickname")
                                                                                        .type(JsonFieldType.STRING)
                                                                                        .description("대댓글에 태그된 멤버 닉네임")
                                                                                        .optional(),
