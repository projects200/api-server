...
public class ExerciseRestController {
    private final ExerciseRecordServiceImpl exerciseRecordServiceImpl;
    ...
    public ResponseEntity<CommonResponse<FindExerciseRecordResponseDto>> findMemberExerciseRecord(@PathVariable @Positive(message = "올바른 Record를 다시 입력해주세요") Long recordId){
        FindExerciseRecordResponseDto responseDto = exerciseRecordServiceImpl.findExerciseRecordByRecordId(recordId);
